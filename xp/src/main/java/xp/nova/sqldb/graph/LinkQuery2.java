...
public class LinkQuery2
{
    ...
    public LinkQuery2(GraphAccess access)
    {
        this.parent=null;
        this.access=access;
        this.graph=null;
    }
    public LinkQuery2(Trace parent,Graph graph)
    {
        this.parent=parent;
        this.graph=graph;
        this.access=null;
    ...
    public LinkQuery2 orderBy(String orderBy)
    {
        this.orderBy=orderBy;
        return this;
    }
    public LinkQuery2 where(String expression,Object...parameters)
    {
    ...
    @SafeVarargs
    final LinkResult[] _execute(long fromNodeId,Class<? extends NodeObject> entityType,Class<? extends GraphObject>...types) throws Throwable
    {
        if (this.access==null)
        {
...
//            long fromNodeId = row.getBIGINT("_link.fromNodeId");
            ...
            for (Class<? extends GraphObject> type:types)
            {
                ...
                case NODE_ATTRIBUTE:
                    ...
                    if (typeNodeId != null)
                    {
                        NodeAttribute nodeAttribute = (NodeAttribute) type.newInstance();
                        for (ColumnAccessor columnAccessor : meta.getColumnAccessors())
                        {
                            columnAccessor.set(nodeAttribute, typeName, row);
                        }
                        nodeAttribute._nodeId=typeNodeId;
                        objects[index++]=nodeAttribute;
                    }
                    break;
                case NODE:
                    throw new Exception();
    ...
    static void buildMap(LinkResult[] results,Class<? extends NodeEntity> entityType,Class<? extends GraphObject>[] types)
    {
    ...
    @SafeVarargs
    final public LinkResult[] getLinkResults(long fromNodeId,Class<? extends NodeEntity> entityType,Class<? extends GraphObject>...types) throws Throwable
    {
    ...
    @SafeVarargs
    final public LinkResult[] getLinkResults(long fromNodeId,Class<? extends GraphObject>...types) throws Throwable
    {
        return getLinkResults(fromNodeId,null,types);
    }
    
    @SafeVarargs
    final public LinkResult getLinkResult(long fromNodeId,Class<? extends NodeEntity> entityType,Class<? extends GraphObject>...types) throws Throwable
    {
    ...
    @SafeVarargs
    final public LinkResult getLinkResult(long fromNodeId,Class<? extends GraphObject>...types) throws Throwable
    {
