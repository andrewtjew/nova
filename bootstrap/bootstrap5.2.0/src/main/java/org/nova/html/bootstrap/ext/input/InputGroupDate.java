...
public class InputGroupDate extends StyleComponent<InputGroupDate>
{
   ...
   //
    public InputGroupDate(String namePrefix,DateFormat dateFormat,int baseYear,int years,Integer yearValue,Integer monthValue,Integer dayValue)
    {
        super("div",null);
        ...
        this.selectYear=new SelectYear(baseYear,years,yearValue);
        this.selectMonth=new SelectMonth().set(monthValue);
        this.selectDay=new SelectDay(dayValue);
    ...
    public InputGroupDate(String namePrefix,DateFormat dateFormat,int baseYear,int years)
    {
...
//    }
    ...
    public SelectYear selectYear()
    {
        return this.selectYear;
    }

    public SelectMonth selectMonth()
    {
