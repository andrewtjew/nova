...
public class RedirectToMessage extends Redirect
{
    ...
    public RedirectToMessage(String messageUrl,String buttonLabel,String title,String message,String url,StyleColor color) throws Exception
    {
    ...
    public RedirectToMessage(String title,String message,String url,StyleColor color) throws Exception
    {
        this(DEFAULT_MESSAGE_URL,DEFAULT_BUTTON_LABEL,title,message,url,color);
    }
    public RedirectToMessage(String title,String message,String url) throws Exception
    {
