...
abstract public class WebSocketHandlerInstancer<STATE,OBJECT extends WebSocketHandler<STATE>>
{
    final protected String webSocketPath;
    public WebSocketHandlerInstancer(String webSocketPath) throws Throwable
    {
        this.webSocketPath=webSocketPath;
        ParameterizedType parameterizedType=(ParameterizedType)this.getClass().getGenericSuperclass();
        Class<?> objectType=(Class<?>)parameterizedType.getActualTypeArguments()[1];
        System.out.println("type:"+objectType.getTypeName());
        register(objectType);
...
//        WebSocketMethod(Method method,String path,ParameterInfo[] parameterInfos,boolean log,boolean logRequestParameters,boolean logRequestContent,boolean logResponseContent,boolean logLastRequestsInMemory,int bufferSize,ClassAnnotations annotations,HashSet<String> hiddenParameters)
...
//        add(httpMethod, fullPath, requestHandler);
    ...
    public abstract WebSocketServer<STATE> createInstance();
}
