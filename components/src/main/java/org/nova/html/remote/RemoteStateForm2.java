...
public class RemoteStateForm2 extends RemoteForm2
{
    ...
    public RemoteStateForm2(String id,RemoteStateBinding binding, String action) throws Throwable
    {
        ...
        this.binding.bind(this,action);
    }
    public RemoteStateForm2(RemoteStateBinding binding,String action) throws Throwable
    {
        this(null,binding, action);
    }

    public RemoteStateForm2(RemoteStateBinding binding) throws Throwable
    {
        this(binding, null);
    }
