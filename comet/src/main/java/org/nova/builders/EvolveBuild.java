...
public class EvolveBuild extends Script
{
    @Override
    public void run(String[] args) throws Throwable
    {
        String artifact = null;
        String sourceDir = "c:\\evolve\\repo\\services2\\";
        String version = "0.0.1-SNAPSHOT";
        String mem="256M";
        boolean noLibs=false;
        boolean noBuild=false;
        String bootstrapVersion="4.1.3";
        String aws=null;
        ...
        if (noBuild==false)
        {
            if (noLibs==false)
            {
                ...
                CometUtils.exec(sourceDir+"messaging","mvn clean install");
                CometUtils.exec(sourceDir+"common","mvn clean install");
                CometUtils.exec(sourceDir+"common-ui-bootstrap"+bootstrapVersion,"mvn clean install");
            }
...
//            CometUtils.deleteDirectory(package_+"\\resources\\client\\games");
        ...
        if (aws!=null)
        {
            ...
            session.copy(sourceDir+"\\packages\\"+destJar,destJar);
