...
//            CometUtils.deleteDirectory(package_+"\\resources\\client\\games");
            ...
            String buildVersion=CometUtils.exec(libDir,"git describe --tags --abbrev=0");
            ...
            //Git stuff
//            CometUtils.exec(libDir,"git add .");
//            CometUtils.exec(libDir,"git tag -a "+buildVersion+" -m \"package build\"");
//            CometUtils.exec(libDir,"git commit -m \""+artifact+" package build version: "+buildVersion+"\"");
//            CometUtils.exec(libDir,"git push");
